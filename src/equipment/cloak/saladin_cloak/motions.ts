...
export const vrmaMotions = {
  saladin_spin: EQUIPMENT_VRMA_CLIPS.slashUp({ interruptibleAfter: .48, playbackRate: 1.45, alignEndWithAction: true, actionDurationSeconds: 32 / 60, fallbackReason: VRMA_FALLBACK_REASONS.slash })
