...
export const vrmaMotions = {
  syal_combo_1: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .4, playbackRate: 1.55, alignEndWithAction: true, actionDurationSeconds: 22 / 60 }),
  syal_combo_2: EQUIPMENT_VRMA_CLIPS.slashToRight({ interruptibleAfter: .4, playbackRate: 1.55, alignEndWithAction: true, actionDurationSeconds: 22 / 60 }),
  syal_combo_3: EQUIPMENT_VRMA_CLIPS.slashUp({ interruptibleAfter: .44, playbackRate: 1.45, alignEndWithAction: true, actionDurationSeconds: 23 / 60 }),
  syal_combo_4: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .48, playbackRate: 1.45, alignEndWithAction: true, actionDurationSeconds: 31 / 60, fallbackReason: VRMA_FALLBACK_REASONS.slash }),
  syal_lunar_slash: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .58, playbackRate: 1.25, alignEndWithAction: true, actionDurationSeconds: 44 / 60, fallbackReason: VRMA_FALLBACK_REASONS.thrust }),
  syal_forward_cut: EQUIPMENT_VRMA_CLIPS.slashToRight({ interruptibleAfter: .5, playbackRate: 1.35, alignEndWithAction: true, actionDurationSeconds: 36 / 60, fallbackReason: VRMA_FALLBACK_REASONS.thrust })
