...
export const vrmaMotions = {
  syal_combo_1: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .4 }),
  syal_combo_2: EQUIPMENT_VRMA_CLIPS.slashToRight({ interruptibleAfter: .4 }),
  syal_combo_3: EQUIPMENT_VRMA_CLIPS.slashUp({ interruptibleAfter: .44 }),
  syal_combo_4: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .48, fallbackReason: VRMA_FALLBACK_REASONS.slash }),
  syal_lunar_slash: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .58, fallbackReason: VRMA_FALLBACK_REASONS.thrust }),
  syal_forward_cut: EQUIPMENT_VRMA_CLIPS.slashToRight({ interruptibleAfter: .5, fallbackReason: VRMA_FALLBACK_REASONS.thrust })
