...
export const vrmaMotions = {
  silver_combo_1: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .42, playbackRate: 1.55, alignEndWithAction: true, actionDurationSeconds: 24 / 60 }),
  silver_combo_2: EQUIPMENT_VRMA_CLIPS.slashToRight({ interruptibleAfter: .42, playbackRate: 1.55, alignEndWithAction: true, actionDurationSeconds: 24 / 60 }),
  silver_combo_3: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .45, playbackRate: 1.55, alignEndWithAction: true, actionDurationSeconds: 24 / 60 }),
  silver_combo_4: EQUIPMENT_VRMA_CLIPS.slashUp({ interruptibleAfter: .48, playbackRate: 1.45, alignEndWithAction: true, actionDurationSeconds: 29 / 60, fallbackReason: VRMA_FALLBACK_REASONS.slash }),
  silver_slash: EQUIPMENT_VRMA_CLIPS.slashToLeft({ interruptibleAfter: .58, playbackRate: 1.25, alignEndWithAction: true, actionDurationSeconds: 48 / 60, fallbackReason: VRMA_FALLBACK_REASONS.slash }),
  silver_thrust: EQUIPMENT_VRMA_CLIPS.slashToRight({ interruptibleAfter: .52, playbackRate: 1.3, alignEndWithAction: true, actionDurationSeconds: 50 / 60, fallbackReason: VRMA_FALLBACK_REASONS.thrust })
