...
export const vrmaMotions = {
  saladin_spiral_kick: EQUIPMENT_VRMA_CLIPS.slashUp({ interruptibleAfter: .45, playbackRate: 1.55, alignEndWithAction: true, actionDurationSeconds: 21 / 60, fallbackReason: VRMA_FALLBACK_REASONS.kick })
