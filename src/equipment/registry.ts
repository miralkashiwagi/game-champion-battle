...
const registrations = {
  saladin_cloak: saladinCloak,
  silver_knight_cloak: silverKnightCloak,
  syal_cloak: syalCloak,
  old_silver_knight_helmet: oldSilverKnightHelmet,
  saladin_headgear: saladinHeadgear,
  silver_knight_helmet: silverKnightHelmet,
  syal_headgear: syalHeadgear,
  saladin_armor: saladinArmor,
  sample_armor: sampleArmor,
  silver_knight_armor: silverKnightArmor,
  syal_armor: syalArmor,
  saladin_twin_blades: saladinTwinBlades,
  silver_knight_sword: silverKnightSword,
  syal_twin_blades: syalTwinBlades
} as const;
